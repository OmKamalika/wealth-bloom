...
import { ArrowRight, Users, TrendingDown, Clock, Shield, CheckCircle } from 'lucide-react';

interface WealthCalculatorLandingProps {
  onStartCalculator: () => void;
}

const WealthCalculatorLanding: React.FC<WealthCalculatorLandingProps> = ({ onStartCalculator }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-orange-50">
      ...
      <header className="px-6 py-4">
        <div className="flex items-center justify-between max-w-6xl mx-auto">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900">Legacy Guardian</span>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              YOUR FAMILY'S WEALTH HAS AN
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">
                EXPIRATION DATE
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Discover when your grandchildren will inherit $0
            </p>
          </div>
          ...
          <button
            ...
            className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-bold py-6 px-12 rounded-3xl text-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-2xl hover:shadow-3xl mb-6"
          >
            <span className="relative z-10">Calculate My Family's Timeline</span>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100">
            <div className="text-center mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div className="text-center">
                  <div className="text-5xl font-bold text-red-500 mb-2">70%</div>
                  <p className="text-gray-600">of family wealth disappears by the 2nd generation</p>
                </div>
                <div className="text-center">
                  <div className="text-5xl font-bold text-red-600 mb-2">90%</div>
                  <p className="text-gray-600">is completely gone by the 3rd generation</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="flex justify-center items-end space-x-8 mb-8">
                {/* Generation 1 */}
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-green-500 rounded-full mb-4 flex items-center justify-center">
                    <span className="text-white font-bold">You</span>
                  </div>
                  <div className="w-20 h-32 bg-gradient-to-t from-green-400 to-green-500 rounded-t-lg relative overflow-hidden">
                ...
                {/* Generation 2 */}
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-yellow-400 to-orange-400 rounded-full mb-4 flex items-center justify-center">
                    <span className="text-white font-bold text-xs">Kids</span>
                  </div>
                  <div className="w-20 h-20 bg-gradient-to-t from-yellow-400 to-orange-400 rounded-t-lg relative overflow-hidden">
                    <div 
                ...
                {/* Generation 3 */}
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-red-400 to-red-500 rounded-full mb-4 flex items-center justify-center">
                    <span className="text-white font-bold text-xs">Grand</span>
                  </div>
                  <div className="w-20 h-8 bg-gradient-to-t from-red-400 to-red-500 rounded-t-lg relative overflow-hidden">
              ...
              <div className="text-center">
                ...
                <button
                  onClick={onStartCalculator}
                  className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105"
                >
      ...
      <section className="px-6 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-3xl p-12 text-white">
            ...
            <button
              onClick={onStartCalculator}
              className="bg-white text-purple-600 hover:bg-gray-100 font-bold py-4 px-12 rounded-2xl text-xl transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
      ...
      <footer className="px-6 py-8 border-t border-gray-200">
        <div className="max-w-6xl mx-auto text-center text-gray-600">
          <p>&copy; 2024 Legacy Guardian. Protecting families, preserving wealth.</p>
        </div>
      </footer>
    </div>
  );
