...
exports.DEFAULT_COUNTDOWN_TIMER = void 0;
exports.fetchCountdownTimer = fetchCountdownTimer;
const supabase_1 = require("../lib/supabase");
/**
 * Default countdown timer values
 */
exports.DEFAULT_COUNTDOWN_TIMER = {
    years: 8,
    months: 3,
    weeks: 0,
    days: 27
 ...
 */
async function fetchCountdownTimer(userId) {
    try {
        ...
        if (error) {
            ...
            return exports.DEFAULT_COUNTDOWN_TIMER;
        }
        ...
        const timer = {
            years: data.countdown_timer.years || exports.DEFAULT_COUNTDOWN_TIMER.years,
            months: data.countdown_timer.months || exports.DEFAULT_COUNTDOWN_TIMER.months,
            weeks: data.countdown_timer.weeks || exports.DEFAULT_COUNTDOWN_TIMER.weeks,
            days: data.countdown_timer.days || exports.DEFAULT_COUNTDOWN_TIMER.days
        };
        return timer;
    }
    catch (error) {
