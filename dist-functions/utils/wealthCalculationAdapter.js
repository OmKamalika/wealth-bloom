...
exports.adaptFromCalculatorData = adaptFromCalculatorData;
exports.adaptToAdvancedEngine = adaptToAdvancedEngine;
exports.adaptAdvancedResults = adaptAdvancedResults;
/**
 ...
 */
function adaptFromCalculatorData(calculatorData) {
    return {
        userProfile: {
 ...
 */
function adaptToAdvancedEngine(inputs) {
    return {
        coreIdentity: {
 ...
 */
function adaptAdvancedResults(advancedResults) {
    return {
...
function determineCityType(zipCode) {
...
function mapAcademicPerformance(performance) {
    switch (performance) {
...
function mapEducationPath(path) {
    switch (path) {
...
function mapRelationshipQuality(quality) {
    return quality;
}
function mapFinancialCapacity(capacity) {
    return capacity;
}
function mapCareWillingness(willingness) {
    switch (willingness) {
...
function estimateParentCareCost(parent) {
...
function isSandwichGeneration(inputs) {
