...
exports.updateCountdownTimer = updateCountdownTimer;
exports.saveCountdownTimer = saveCountdownTimer;
exports.loadCountdownTimer = loadCountdownTimer;
/**
 ...
 */
function updateCountdownTimer(timer, lastUpdateTime) {
 ...
 */
function saveCountdownTimer(timer) {
    const now = Date.now();
